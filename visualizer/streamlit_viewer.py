...
class StreamlitViewer:
    ...
    def _render_timeline_histogram(self, project_data: ProjectData):
            ...
            if visible_timestamps:  # Character appears somewhere
                ...
                fig.add_trace(
                    go.Scatter(
                        ...
                        mode='markers+lines',
                        name=char_id,
                        line=dict(color=char_color, width=2),
                        marker=dict(
                            color=point_colors,
                            size=point_sizes,
        ...
        fig.update_layout(
            ...
            margin=dict(t=120, b=60, l=60, r=60),  # Increased top margin for titles
            title=dict(
        ...
        for i in fig['layout']['annotations']:
            i['font'] = dict(size=14, color='white')  # Larger, white titles
